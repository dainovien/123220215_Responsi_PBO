...
jButton2.addActionListener(new java.awt.event.ActionListener() {
    ...
    private javax.swing.JTable TabelData = new javax.swing.JTable();
...
public JTable getTabelData() {
    ...
    public void setTabelDataModel(DefaultTableModel model) {
        TabelData.setModel(model);
    }
    
    public boolean isCellEditable(int row, int column) {
        // Disable editing for the ID column (column 0)
        return column != 0;
    }
}
